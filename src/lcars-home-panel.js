        ...
        <section class="console">
          ...
          <div class="columns">
            <section class="left-column">
              ...
              <article class="panel forecast-panel"><div class="tab lilac">HOURLY WEATHER · RAIN</div><div class="forecast">${hourly}</div></article>
              <article class="panel forecast-panel daily"><div class="tab lilac">DAILY WEATHER · RAIN</div><div class="forecast">${daily}</div></article>
            </section>
            <section class="right-column">
              <article class="panel calendar-panel"><div class="tab apricot">CALENDAR · TODAY</div><div class="events">${events}</div></article>
              <article class="panel feed-panel fuel"><div class="tab gold">FUEL · MARKHAM</div><div class="feed">${fuel}</div></article>
...
.columns { min-height:0; flex:1; display:grid; grid-template-columns:minmax(0,.91fr) minmax(0,1.09fr); gap:10px; } .left-column,.right-column { min-width:0; display:flex; flex-direction:column; gap:10px; } .left-column .climate-panel,.left-column .conditions-panel,.left-column .forecast-panel { flex:none; } .calendar-panel { flex:1; min-height:190px; display:flex; flex-direction:column; } .feed-panel.word { min-height:175px; flex:.72; display:flex; flex-direction:column; } .feed-panel.word .feed { flex:1; display:flex; flex-direction:column; justify-content:flex-start; padding-top:12px; font-size:15px; line-height:1.38; } .feed-panel.fuel { min-height:66px; }
