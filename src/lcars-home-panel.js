...
.cameras-panel { --panel:var(--sky); } .cameras { display:grid; grid-template-columns:1fr 1fr; gap:4px; padding:6px; flex:1; min-height:0; } .camera { background:#15171e; min-width:0; min-height:0; overflow:hidden; position:relative; } .camera-stream { display:block; height:100%; width:100%; background:#0a0b0e; } .camera-label { position:absolute; inset:auto 0 0; min-height:23px; padding:5px 6px; background:rgba(5,6,9,.78); display:flex; justify-content:space-between; align-items:center; color:#edf5f6; font-size:8px; font-weight:850; letter-spacing:.06em; pointer-events:none; } .camera-label b { color:var(--sky); font-size:7px; }
